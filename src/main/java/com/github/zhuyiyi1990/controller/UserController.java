...
import com.github.zhuyiyi1990.exception.SysException;
...
//        return "forward:/WEB-INF/pages/success.jsp";
    ...
    public String testFileUpload2(HttpServletRequest request, @RequestParam("upload") MultipartFile zhuyiyi) throws IOException {
        ...
        //获取上传文件名称
        String fileName = zhuyiyi.getOriginalFilename();
        //把文件的名称设置成唯一值, uuid
        String uuid = UUID.randomUUID().toString().replace("-", "");
        fileName = uuid + "_" + fileName;
        //完成文件上传
        zhuyiyi.transferTo(new File(path, fileName));
